...
/**
 * Waiter to handle events related to the Cyberiq controls (i.e. Bake, Step, Save, Load etc.)
 */
class ControlsWaiter {
     ...
     *
     * @param {App} app - The main view object for Cyberiq.
     * @param {Manager} manager - The Cyberiq event manager.
     */
     ...
     * @param {string} input
     * @param {Object[]} [recipeConfig] - The recipe configuration object array.
     * @param {string} [baseURL] - The Cyberiq URL, set to the current URL if not included
     * @returns {string}
     */
    ...
    supportButtonClick(e) {
        ...
        const saveLink = this.generateStateUrl(true, true, null, null, "https://gchq.github.io/Cyberiq/");
