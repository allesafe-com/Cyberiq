...
/**
 * HTML view for Cyberiq responsible for building the web page and dealing with all user
 * interactions.
 */
class App {
    ...
    setCompileMessage() {
        ...
        // const compareURL = `https://github.com/gchq/Cyberiq/compare/v${prev.join(".")}...v${PKG_VERSION}`;

        let compileInfo = `<a href='https://github.com/gchq/Cyberiq/blob/master/CHANGELOG.md'>Last build: ${timeSinceCompile.substr(0, 1).toUpperCase() + timeSinceCompile.substr(1)} ago</a>`;
        ...
        notice.setAttribute("data-help", "This live version of Cyberiq is updated whenever new commits are added to the master branch of the Cyberiq repository. It represents the latest, most up-to-date build of Cyberiq.");
    }
