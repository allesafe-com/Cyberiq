...
class Utils {
     ...
     * Unicode Private Use Area, which Cyberiq will display as control characters.
     ...
     * Private Use Area, which Cyberiq will display as a control character picture.
     ...
     * -._~!$&'()*+,;=:@/?
     *
     * & and = are still escaped as they are used to serialise the key-value pairs in Cyberiq
     ...
     *
     * "Pretty" Cyberiq recipe formats are designed to be included in the fragment (#) or query (?)
     * parts of the URL. They can also be loaded into Cyberiq through the 'Load' interface. In order
