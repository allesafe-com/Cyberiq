...
/**
 * The main controller for Cyberiq.
 */
class Chef {
    ...
    */
     ...
     * it swaps out the memory for that tab. If the Cyberiq tab has been unfocused for more than a
     * minute, we run a silent bake which will force the browser to load and cache all the relevant
     * JavaScript code needed to do a real bake.
     *
     * This will stop baking taking a long time when the Cyberiq browser tab has been unfocused for a
